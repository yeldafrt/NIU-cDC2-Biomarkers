...
- Nested Cross-validation AUC: 0.863 | Independent test AUC: 0.855
- Permutation test: p = 0.005
- LODO cross-platform validation: mean AUC = 0.819
- All 20 selected genes are disease-upregulated
- Top biomarkers: CD180, CX3CR1, CCR2, TLR7, DHRS9
- 474 significantly enriched pathway terms (adjusted p < 0.05)
...
.
├── code/
│   ├── 01_data_download/       # Data download scripts
│   ├── 02_data_preparation/    # Normalization, batch correction, and ML-ready pipeline
│   ├── 03_ml_pipeline_v6.1/    # Feature selection, model training, grid search
│   ├── 04_gene_enrichment/     # Gene annotation and pathway enrichment analysis
│   ├── 05_figures/             # Figure generation scripts
│   └── 06_reviewer_response/   # Nested CV and feature stability robustness analyses
├── csv/
...
│   ├── batch_correction_comparison.json
│   ├── final_summary.json
│   └── reviewer_robustness_analysis/ # Nested CV and feature stability results
├── dataset/
...
│   ├── gene_list_healthy_up.txt
│   └── all_8767_genes_annotated.csv
├── models/
